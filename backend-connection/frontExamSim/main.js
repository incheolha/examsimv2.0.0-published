...
let AppComponent = class AppComponent {
    constructor(utilityService, authService, router, changeDetector) {
...
/* harmony import */ var _profile_model__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./profile.model */ "./src/app/auth/profile.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let LoginComponent = class LoginComponent {
    constructor(fb, authService, router, utilityService) {
        this.fb = fb;
        this.authService = authService;
        this.router = router;
        this.utilityService = utilityService;
    ...
    onSubmit() {
        ...
        const user = new _user_model__WEBPACK_IMPORTED_MODULE_4__["User"](this.loginForm.value.email, this.loginForm.value.password);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _profile_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../profile.model */ "./src/app/auth/profile.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__decorate([
    ...
    __metadata("design:type", _profile_model__WEBPACK_IMPORTED_MODULE_1__["ProfileInfo"])
], EditUserProfileComponent.prototype, "profileInfo", void 0);
...
class Shoppingcart {
    constructor(examNo, examLevel, examPrice) {
        this.examNo = examNo;
...
/* harmony import */ var _Utility_shared_globalConstantShare__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../Utility-shared/globalConstantShare */ "./src/app/Utility-shared/globalConstantShare.ts");
/* harmony import */ var _shoppingcart_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../shoppingcart.service */ "./src/app/payment/shoppingcart.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let PaypalPaymentService = class PaypalPaymentService {
    ...
    checkoutPaypal(payment) {
        ...
        const headers = new _angular_http__WEBPACK_IMPORTED_MODULE_3__["Headers"]({ 'Content-Type': 'application/json' });
    ...
    handleErrors(error) {
        ...
        console.log(err);
        return rxjs_Observable__WEBPACK_IMPORTED_MODULE_4__["Observable"].throw(error);
    }
};
